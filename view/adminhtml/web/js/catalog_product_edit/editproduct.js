require(["jquery"], function ($){
	...
	$(document).on('click', ".productdesigner-toggle-part", function(){
		$(this).next('.productdesigner-part-container').toggle();
	});
	
	$(document).on('click', ".productdesigner-menu-item", function(){
		var menuItem = $(this).data('menu_item');
		$(".productdesigner-menu-item").removeClass('active');
		$(this).addClass('active');
		$(".productdesigner-part-wrapper").hide();
		$(".productdesigner-part-wrapper[data-menu_item="+menuItem+"]").show();
	});
	...
	$(document).on('click', ".deleteside", function(){
		...
		$(document).on('click', ".deletemaat", function(){
			var delid = $(this).attr('id');
			delid = delid.replace('del_', '');
	...
	$(document).on('click', "#drukaddbutton", function(){
	...
	$(document).on('click', ".deletedruktype", function(){
		var delid = $(this).attr('id');
		delid = delid.replace('del_', '');
	...
	$(document).on('click', "#textcoloraddbutton", function(){
	...
	$(document).on('click', ".deletetextcolor", function(){
		var delid = $(this).attr('id');
		delid = delid.replace('del_', '');

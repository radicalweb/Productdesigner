...
*/
		$viewBoxX1 = $saveObject->getData('output_x1') - 4;
		$viewBoxY1 = $saveObject->getData('output_y1') - 4;
		$viewBoxWidth = $saveObject->getData('output_x2') - $saveObject->getData('output_x1');
		$viewBoxHeight = $saveObject->getData('output_y2') - $saveObject->getData('output_y1');

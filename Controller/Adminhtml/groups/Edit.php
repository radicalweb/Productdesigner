...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Laurensmedia\Productdesigner\Model\Groups');
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Edit Item').' '.$model->getId().' : '.$model->getCode() : __('New Item'));

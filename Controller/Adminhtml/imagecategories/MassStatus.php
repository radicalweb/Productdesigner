...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Laurensmedia\Productdesigner\Model\Imagecategories')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('productdesigner/*/index');
    }

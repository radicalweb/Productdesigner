...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('fonts')->getId()) {
            return __("Edit Fonts '%1'", $this->escapeHtml($this->_coreRegistry->registry('fonts')->getTitle()));
        } else {
            return __('New Fonts');
        }
    }

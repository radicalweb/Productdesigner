...
*/
		...
		$fieldset->addField('clean_uploads', 'checkbox', 
			array(
				'label' => __('Clean up uploaded images'),
				'class' => 'entry',
				'required' => false,
				'name' => 'clean_uploads',
				'value' => 'true',
		...
		$fieldset->addField('clean_svg', 'checkbox', 
			array(
				'label' => __('Clean up svg files'),
				'class' => 'entry',
				'required' => false,
				'name' => 'clean_svg',
				'value' => 'true',
		...
		$fieldset->addField('clean_png', 'checkbox', 
			array(
				'label' => __('Clean up png cart image files'),
				'class' => 'entry',
				'required' => false,
				'name' => 'clean_png',
				'value' => 'true',
		...
		$fieldset->addField('clean_json', 'checkbox', 
			array(
				'label' => __('Clean up json files'),
				'class' => 'entry',
				'required' => false,
				'name' => 'clean_json',
				'value' => 'true',
        ...
        $fieldset->addField('clean_bulk_pdf', 'checkbox', 
            array(
                'label' => __('Clean all generated bulk PDF files'),
                'class' => 'entry',
                'required' => false,
                'name' => 'clean_bulk_pdf',
                'value' => 'true',

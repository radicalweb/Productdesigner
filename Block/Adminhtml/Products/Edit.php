...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize products edit block
     *
     * @return void
     */
    protected function _construct()
    {
        ...
        $this->buttonList->update('delete', 'label', __('Delete Products'));
    }
    ...
    {
        if ($this->_coreRegistry->registry('products')->getId()) {
            return __("Edit Products '%1'", $this->escapeHtml($this->_coreRegistry->registry('products')->getTitle()));
        } else {
